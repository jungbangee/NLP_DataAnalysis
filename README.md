...
| **[2] 발화자 감정 판별** | **KoBERT & FT-Transformer 기반 멀티모델 심리 분석**<br>• 대화 텍스트(Text)와 인구통계 정보(Tabular) 결합<br>• **Cross-Attention**을 활용한 Late Fusion 아키텍처<br>• 발화자의 불안/우울 지수 예측 멀티태스크 학습 |   <br> `FT-Transformer` `Pandas` `Scikit-learn` |
